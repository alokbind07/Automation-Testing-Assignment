...
public class OnboardingTest extends BaseTest {
    ...
    public void testSuccessfulOnboarding() throws Exception {
        ...
        // Ensure duplicate in-process provider draft with our target NPI is cleaned up
        // globally
        ...
        ReportUtils.logInfo(
                "Entering Provider Details. NPI: " + npi + ", First Name: " + firstName + ", Last Name: " + lastName);
        ...
        Assert.assertTrue(driver.getWindowHandles().size() > 1,
                "Failed to submit onboarding request or open a new tab with NPI: " + npi);
        ...
        ReportUtils.logInfo("Filling out Provider Form Details. SSN: " + ssn + ", Email: " + emailAddress + ", DOB: "
                + dob + ", Phone: " + phone + ", Gender: " + gender + ", Certifying Board: " + certifyingBoard);
        ...
        try {
            java.nio.file.Files.writeString(java.nio.file.Path.of("target/additional_basic_info.html"),
                    driver.getPageSource());
            ReportUtils.logInfo(
                    "Saved page source for Additional Basic Information page to target/additional_basic_info.html");
        } catch (IOException e) {
            ReportUtils.logInfo("Failed to save page source for Additional Basic Information: " + e.getMessage());
        }

        ReportUtils.logInfo(
                "Filling Additional Basic Information form details: Street='123 Main St', State='California', City='Los Angeles', Zip='90001'");
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(
                By.xpath("//input[contains(@id, 'userName')] | //input[contains(@placeholder, 'username')]")));
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
                "//input[@id='flexCheckDefault'] | //input[@type='checkbox' and following-sibling::label[contains(text(), 'CORE PRIVILEGES') or contains(text(), 'Core Privileges')]]")));
        ...
        wait.until(ExpectedConditions
                .elementToBeClickable(By.xpath("//label[@for='boardCertified11'] | //label[@for='boardCertified12']")));
        ...
        try {
            java.nio.file.Files.writeString(java.nio.file.Path.of("target/professional_reference.html"),
                    driver.getPageSource());
            ReportUtils.logInfo("Saved page source for Professional Reference to target/professional_reference.html");
            File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
            java.nio.file.Files.copy(screenshot.toPath(), java.nio.file.Path.of("target/professional_reference.png"),
        ...
        professionalReferencePage.fillProfessionalReferenceDetails("Alok Reference One", "Supervisor", "5551234567",
                "alok1@gmail.com", "Bob Reference Two", "Colleague", "5557654321", "bob2@gmail.com");
        ...
        try {
            java.nio.file.Files.writeString(java.nio.file.Path.of("target/upload_documents.html"),
                    driver.getPageSource());
        ...
        try {
            File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
            java.nio.file.Files.copy(screenshot.toPath(), java.nio.file.Path.of("target/upload_documents.png"),
                    java.nio.file.StandardCopyOption.REPLACE_EXISTING);
        ...
        try {
            File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
            java.nio.file.Files.copy(screenshot.toPath(), java.nio.file.Path.of("target/attestations.png"),
                    java.nio.file.StandardCopyOption.REPLACE_EXISTING);
